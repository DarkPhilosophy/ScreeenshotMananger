...
object DebugLogger {
    ...
    fun warning(tag: String, message: String, throwable: Throwable? = null) {
        ...
        val entry = LogEntry(System.currentTimeMillis(), LogLevel.WARNING, tag, message, throwableStack)
    ...
    fun error(tag: String, message: String, throwable: Throwable? = null) {
        val throwableStack = throwable?.let { Log.getStackTraceString(it) }
        val entry = LogEntry(System.currentTimeMillis(), LogLevel.ERROR, tag, message, throwableStack)
