# Ko - Screenshot Manager Quick Start

This guide will get you up and running with the Ko Screenshot Manager Android app quickly.
...
2. Click "Open" and select the `Ko` folder
...
3. Modify `SettingsActivity.kt` for new preferences
