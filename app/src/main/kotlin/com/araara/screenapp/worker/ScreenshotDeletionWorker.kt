package com.araara.screenapp.worker
...
class ScreenshotDeletionWorker @AssistedInject constructor(
    ...
    private val repository: com.araara.screenapp.data.repository.ScreenshotRepository,
    ...
    private suspend fun deleteScreenshot(screenshot: com.araara.screenapp.data.entity.Screenshot) {
        DebugLogger.info(
            "ScreenshotDeletionWorker",
