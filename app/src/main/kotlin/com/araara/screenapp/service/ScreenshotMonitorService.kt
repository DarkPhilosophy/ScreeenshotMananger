...
import com.araara.screenapp.ui.MainActivity
...
class ScreenshotMonitorService : Service() {
    ...
    @Inject
    lateinit var repository: com.araara.screenapp.data.repository.ScreenshotRepository

    @Inject
    lateinit var refreshFlow: MutableSharedFlow<Unit>

    @Inject
    lateinit var preferences: com.araara.screenapp.data.preferences.AppPreferences
