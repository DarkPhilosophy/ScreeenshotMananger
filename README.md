...
[![Build Status](https://github.com/DarkPhilosophy/Ko/actions/workflows/pre-merge.yaml/badge.svg)](https://github.com/DarkPhilosophy/Ko/actions)
...
2. Download the latest `ko-debug.apk` or `ko-release.apk`
...
**Made with ❤️ by [DarkPhilosophy](https://github.com/DarkPhilosophy)**
